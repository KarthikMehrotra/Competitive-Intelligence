...
url = 'https://www.alphavantage.co/query?function=NEWS_SENTIMENT&tickers=AMZN&topics=earnings,merger&acquistions,economy_macro,financial_markets&time_from=20230508T0130&time_to=20230608T0130&apikey=9GEPM841QDY4HGPG'
response = requests.get(url)
data = response.json()

# Specify the path for the JSON file
json_file_path = folder_path + '\\amazon_may.json'
