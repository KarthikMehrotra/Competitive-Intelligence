...
csv_file_name = 'extracted_data_gcp_microsoft_v2.csv'
...
with open(csv_file_path, 'w', newline='', encoding='utf-8') as file:
    ...
    for item in extracted_data:
        ...
        for entity in entities:
            ...
            salience = entity['salience']
            writer.writerow([url, content, name, salience, '', item['timestamp'], 'microsoft'])

        verbs = item['verbs']
        for verb in verbs:
            writer.writerow([url, content, '', '', verb, item['timestamp'], 'microsoft'])
