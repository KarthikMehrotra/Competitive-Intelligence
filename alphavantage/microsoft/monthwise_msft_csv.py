...
json_file_path = r'C:\Users\karth\AppData\Local\Programs\Python\Python311\Coforge\alphavantage\microsoft\microsoft_may.json'
csv_file_path = r'C:\Users\karth\AppData\Local\Programs\Python\Python311\Coforge\alphavantage\microsoft\microsoft_may.csv'
...
with open(csv_file_path, 'w', newline='') as file:
    ...
    for item in data:
        ...
        writer.writerow(['Microsoft', url, time_published, topic, relevance_score,
                         ticker, ticker_relevance_score, ticker_sentiment_score, ticker_sentiment_label])
