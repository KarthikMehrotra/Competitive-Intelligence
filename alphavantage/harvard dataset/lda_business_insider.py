...
# Visualization
LDAvis_data_filepath = os.path.join('C:\\Users\\karth\\AppData\\Local\\Programs\\Python\\Python311\\Coforge\\alphavantage\\harvard dataset', 'ldavis_prepared_' + str(num_topics))
...
pyLDAvis.save_html(LDAvis_prepared, os.path.join('C:\\Users\\karth\\AppData\\Local\\Programs\\Python\\Python311\\Coforge\\alphavantage\\harvard dataset', 'ldavis_prepared_' + str(num_topics) + '.html'))
